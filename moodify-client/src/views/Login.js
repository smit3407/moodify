...
function Login() {
  ...
  const REACT_APP_REDIRECT_URL = 'http://localhost:3000/moodify/dashboard';
  ...
  const authorizeSpotify = () => {
    window.location.href = `${REACT_APP_AUTHORIZE_URL}?client_id=${REACT_APP_CLIENT_ID}&redirect_uri=${REACT_APP_REDIRECT_URL}&scope=${scopes.join('%20')}&response_type=token&show_dialog=true`;
  };
